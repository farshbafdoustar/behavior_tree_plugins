#ifndef BEHAVIOR_TREE_PLUGIN_ROS_INDEX_ARRAY_H
#define BEHAVIOR_TREE_PLUGIN_ROS_INDEX_ARRAY_H
...
{
class IndexArray : public BT::SyncActionNode
{
public:
  IndexArray(const std::string& name, const BT::NodeConfig& config, ros::NodeHandle& node_handle,
...
#endif  // BEHAVIOR_TREE_PLUGIN_ROS_INDEX_ARRAY_H
